...
if option == "🤖 AI Buddy (ChatBot)":
    ...
    if user_input:
        ...
        - If asked "Who made you?", answer: "I was created by Shubham Tade, an AI Engineer." (Share his LinkedIn 'https://www.linkedin.com/in/shubham-tade123/' only if explicitly asked).
